...
trainedModelFolder=os.path.join(BASE_DIR,"TrainedModel")
trainedModelPath=os.path.join(trainedModelFolder,"flight_rf.pkl")
...
def index(request):
    ...
    prediction_text="Your Flight price is Rs. ______"
    context={
        'prediction_text':prediction_text
    }
    return render(request,"main/index.html",context=context)